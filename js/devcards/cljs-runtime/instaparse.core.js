...
if(cljs.core.truth_((function (){var fexpr__57956 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__57960 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57960.cljs$core$IFn$_invoke$arity$1 ? fexpr__57960.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57960.call(null,type));
})())){
} else {
...
var G__57962 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57962)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57962)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57962)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57962)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57962)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57967){
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57963){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57964,G__57965,seq57963__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57993){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57997 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57997) : instaparse.reduction.node_builders.call(null,G__57997));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57986){
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k58007,else__4442__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__58017){
var vec__58018 = p__58017;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58018,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58018,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__58025 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__58025(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this58008,other58009){
var self__ = this;
var this58008__$1 = this;
return (((!((other58009 == null)))) && ((this58008__$1.constructor === other58009.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58008__$1.grammar,other58009.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58008__$1.start_production,other58009.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58008__$1.output_format,other58009.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58008__$1.__extmap,other58009.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__58006){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__58026 = cljs.core.keyword_identical_QMARK_;
var expr__58027 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__58029 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__58030 = expr__58027;
return (pred__58026.cljs$core$IFn$_invoke$arity$2 ? pred__58026.cljs$core$IFn$_invoke$arity$2(G__58029,G__58030) : pred__58026.call(null,G__58029,G__58030));
})())){
return (new instaparse.core.Parser(G__58006,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58031 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__58032 = expr__58027;
return (pred__58026.cljs$core$IFn$_invoke$arity$2 ? pred__58026.cljs$core$IFn$_invoke$arity$2(G__58031,G__58032) : pred__58026.call(null,G__58031,G__58032));
})())){
return (new instaparse.core.Parser(self__.grammar,G__58006,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58033 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__58034 = expr__58027;
return (pred__58026.cljs$core$IFn$_invoke$arity$2 ? pred__58026.cljs$core$IFn$_invoke$arity$2(G__58033,G__58034) : pred__58026.call(null,G__58033,G__58034));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__58006,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__58006),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__58006){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__58006,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__58035 = (arguments.length - (1));
switch (G__58035) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args58011){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args58011)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__58010){
var extmap__4478__auto__ = (function (){var G__58036 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__58010,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__58010)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58036);
} else {
return G__58036;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__58010),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__58010),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__58010),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__58039){
...
var _STAR_case_insensitive_literals_STAR__orig_val__58042 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__58043 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__58043);

try{var G__58044 = input_format;
var G__58044__$1 = (((G__58044 instanceof cljs.core.Keyword))?G__58044.fqn:null);
switch (G__58044__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58044__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__58042);
}});
...
var map__58045 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58045__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58045__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq58037){
var G__58038 = cljs.core.first(seq58037);
var seq58037__$1 = cljs.core.next(seq58037);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58038,seq58037__$1);
}));
