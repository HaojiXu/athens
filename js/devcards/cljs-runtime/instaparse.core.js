...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57948){
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57945){
...
var G__58041 = (i__4790__auto___58040 + (1));
i__4790__auto___58040 = G__58041;
continue;
} else {
}
break;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57958 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57952){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57953,G__57954,seq57952__$2);
}));
...
var h__4297__auto____$1 = (function (){var fexpr__57970 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57970(this__4435__auto____$1);
})();
...
var expr__57972 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57974 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57975 = expr__57972;
return (pred__57971.cljs$core$IFn$_invoke$arity$2 ? pred__57971.cljs$core$IFn$_invoke$arity$2(G__57974,G__57975) : pred__57971.call(null,G__57974,G__57975));
})())){
...
if(cljs.core.truth_((function (){var G__57976 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57977 = expr__57972;
return (pred__57971.cljs$core$IFn$_invoke$arity$2 ? pred__57971.cljs$core$IFn$_invoke$arity$2(G__57976,G__57977) : pred__57971.call(null,G__57976,G__57977));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57959,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57978 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57979 = expr__57972;
return (pred__57971.cljs$core$IFn$_invoke$arity$2 ? pred__57971.cljs$core$IFn$_invoke$arity$2(G__57978,G__57979) : pred__57971.call(null,G__57978,G__57979));
})())){
...
var self__ = this;
var self__ = this;
var G__57980 = (arguments.length - (1));
switch (G__57980) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57964){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57964)));
}));
...
var extmap__4478__auto__ = (function (){var G__57992 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57963,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57963)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57992);
} else {
return G__57992;
}
})();
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__58007){
...
var _STAR_case_insensitive_literals_STAR__orig_val__58027 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__58028 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__58028);

try{var G__58029 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58029__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__58027);
}});
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq58004){
var G__58005 = cljs.core.first(seq58004);
var seq58004__$1 = cljs.core.next(seq58004);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58005,seq58004__$1);
}));
