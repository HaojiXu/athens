...
if(cljs.core.truth_((function (){var fexpr__57949 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57949.cljs$core$IFn$_invoke$arity$1 ? fexpr__57949.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57949.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57957 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57957.cljs$core$IFn$_invoke$arity$1 ? fexpr__57957.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57957.call(null,type));
})())){
} else {
...
var G__57966 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57966)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57966)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57966)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57966)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57966)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57976){
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57968){
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57992){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57993,G__57994,seq57992__$2);
}));
