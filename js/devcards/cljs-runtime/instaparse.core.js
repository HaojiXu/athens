...
if(cljs.core.truth_((function (){var fexpr__57986 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57986.cljs$core$IFn$_invoke$arity$1 ? fexpr__57986.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57986.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57987 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57987.cljs$core$IFn$_invoke$arity$1 ? fexpr__57987.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57987.call(null,type));
})())){
} else {
...
var G__57988 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57988)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57988)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57988)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57988)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57988)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57992){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57995 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57995) : instaparse.reduction.node_builders.call(null,G__57995));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57989){
var G__57990 = cljs.core.first(seq57989);
var seq57989__$1 = cljs.core.next(seq57989);
var G__57991 = cljs.core.first(seq57989__$1);
var seq57989__$2 = cljs.core.next(seq57989__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57990,G__57991,seq57989__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57999){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__58002 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__58002) : instaparse.reduction.node_builders.call(null,G__58002));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57996){
var G__57997 = cljs.core.first(seq57996);
var seq57996__$1 = cljs.core.next(seq57996);
var G__57998 = cljs.core.first(seq57996__$1);
var seq57996__$2 = cljs.core.next(seq57996__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57997,G__57998,seq57996__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k58004,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k58004,else__4442__auto__);
...
var h__4297__auto____$1 = (function (){var fexpr__58014 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__58014(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this58005,other58006){
var self__ = this;
var this58005__$1 = this;
return (((!((other58006 == null)))) && ((this58005__$1.constructor === other58006.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58005__$1.grammar,other58006.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58005__$1.start_production,other58006.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58005__$1.output_format,other58006.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58005__$1.__extmap,other58006.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__58003){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__58015 = cljs.core.keyword_identical_QMARK_;
var expr__58016 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__58018 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__58019 = expr__58016;
return (pred__58015.cljs$core$IFn$_invoke$arity$2 ? pred__58015.cljs$core$IFn$_invoke$arity$2(G__58018,G__58019) : pred__58015.call(null,G__58018,G__58019));
})())){
return (new instaparse.core.Parser(G__58003,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58020 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__58021 = expr__58016;
return (pred__58015.cljs$core$IFn$_invoke$arity$2 ? pred__58015.cljs$core$IFn$_invoke$arity$2(G__58020,G__58021) : pred__58015.call(null,G__58020,G__58021));
})())){
return (new instaparse.core.Parser(self__.grammar,G__58003,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58022 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__58023 = expr__58016;
return (pred__58015.cljs$core$IFn$_invoke$arity$2 ? pred__58015.cljs$core$IFn$_invoke$arity$2(G__58022,G__58023) : pred__58015.call(null,G__58022,G__58023));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__58003,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__58003),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__58003){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__58003,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__58024 = (arguments.length - (1));
switch (G__58024) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args58008){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args58008)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__58007){
var extmap__4478__auto__ = (function (){var G__58025 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__58007,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__58007)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58025);
} else {
return G__58025;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__58007),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__58007),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__58007),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__58028){
...
var _STAR_case_insensitive_literals_STAR__orig_val__58031 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__58032 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__58032);

try{var G__58033 = input_format;
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__58031);
}});
...
var map__58034 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58034__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58034__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq58026){
var G__58027 = cljs.core.first(seq58026);
var seq58026__$1 = cljs.core.next(seq58026);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58027,seq58026__$1);
}));
