...
var G__25755 = cljs.core.first(poshdb);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25755__$1)].join('')));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__25781,poshdb){
var map__25782 = p__25781;
