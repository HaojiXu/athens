...
var n__4666__auto___24909 = l__24795__auto___24907;
...
var pos_25053 = (0);
while(true){
var rest_25055 = (len - pos_25053);
if((rest_25055 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25053));
} else {
if((rest_25055 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25053,(pos_25053 + chunk_len)));

var G__25060 = (pos_25053 + chunk_len);
pos_25053 = G__25060;
continue;
} else {
var piece_len_25061 = (rest_25055 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25053,(pos_25053 + piece_len_25061)));

var G__25062 = (pos_25053 + piece_len_25061);
pos_25053 = G__25062;
continue;
