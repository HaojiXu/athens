...
while(true){
if((i__24796__auto___24918 < n__4666__auto___24916)){
...
var n__4666__auto___24922 = l__24795__auto___24920;
...
var G__24924 = (i__24796__auto___24923 + (1));
i__24796__auto___24923 = G__24924;
continue;
} else {
}
break;
...
while(true){
if((level__$1 > (0))){
var G__24964 = (function (){var arr__24810__auto__ = node__$1.pointers;
return (arr__24810__auto__[(arr__24810__auto__.length - (1))]);
})();
var G__24965 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__24966 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__24964;
path = G__24965;
level__$1 = G__24966;
continue;
...
var G__24992 = (left__$1 + (1));
var G__24993 = keys__$1;
var G__24994 = (idx__$1 + (1));
var G__24995 = new_acc;
left__$1 = G__24992;
keys__$1 = G__24993;
idx__$1 = G__24994;
acc = G__24995;
...
var G__24999 = new_left;
var G__25000 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__25001 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__25002 = new_acc;
left__$1 = G__24999;
keys__$1 = G__25000;
idx__$1 = G__25001;
acc = G__25002;
...
var G__25036 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__25037 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__25036;
res = G__25037;
continue;
}
...
var pos_25058 = (0);
while(true){
var rest_25059 = (len - pos_25058);
if((rest_25059 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25058));
} else {
if((rest_25059 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25058,(pos_25058 + chunk_len)));

var G__25061 = (pos_25058 + chunk_len);
pos_25058 = G__25061;
continue;
} else {
var piece_len_25062 = (rest_25059 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25058,(pos_25058 + piece_len_25062)));

var G__25063 = (pos_25058 + piece_len_25062);
pos_25058 = G__25063;
continue;
...
var G__25074 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__25075 = (i + (1));
var G__25076 = e;
acc = G__25074;
i = G__25075;
...
break;
default:
var G__25119 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__24874,leaves){
...
var G__25120 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__25119;
shift = G__25120;
continue;
...
args_arr__4810__auto__.push((arguments[i__4790__auto___25125]));
...
args_arr__4810__auto__.push((arguments[i__4790__auto___25135]));
