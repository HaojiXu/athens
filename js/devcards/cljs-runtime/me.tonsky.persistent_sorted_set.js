...
while(true){
if((level > (0))){
var G__24962 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__24963 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__24962;
node = G__24963;
continue;
} else {
...
var pos_25060 = (0);
while(true){
var rest_25061 = (len - pos_25060);
if((rest_25061 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25060));
} else {
if((rest_25061 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25060,(pos_25060 + chunk_len)));

var G__25066 = (pos_25060 + chunk_len);
pos_25060 = G__25066;
continue;
} else {
var piece_len_25067 = (rest_25061 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25060,(pos_25060 + piece_len_25067)));

var G__25068 = (pos_25060 + piece_len_25067);
pos_25060 = G__25068;
continue;
...
var G__25085 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__25086 = (i + (1));
var G__25087 = e;
acc = G__25085;
i = G__25086;
