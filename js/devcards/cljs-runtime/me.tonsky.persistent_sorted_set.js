...
while(true){
if((level__$1 > (0))){
var G__24970 = (function (){var arr__24810__auto__ = node__$1.pointers;
return (arr__24810__auto__[(arr__24810__auto__.length - (1))]);
})();
var G__24971 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__24972 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__24970;
path = G__24971;
level__$1 = G__24972;
continue;
...
var G__25060 = (node.pointers[idx]);
var G__25061 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__25062 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__25060;
path = G__25061;
level = G__25062;
continue;
...
var pos_25089 = (0);
while(true){
var rest_25091 = (len - pos_25089);
if((rest_25091 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25089));
} else {
if((rest_25091 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25089,(pos_25089 + chunk_len)));

var G__25098 = (pos_25089 + chunk_len);
pos_25089 = G__25098;
continue;
} else {
var piece_len_25099 = (rest_25091 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25089,(pos_25089 + piece_len_25099)));

var G__25103 = (pos_25089 + piece_len_25099);
pos_25089 = G__25103;
continue;
...
break;
default:
var G__25136 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__24874,leaves){
...
var G__25137 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__25136;
shift = G__25137;
continue;
