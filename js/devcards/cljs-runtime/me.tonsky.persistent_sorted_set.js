...
var pos_25086 = (0);
while(true){
var rest_25088 = (len - pos_25086);
if((rest_25088 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25086));
} else {
if((rest_25088 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25086,(pos_25086 + chunk_len)));

var G__25093 = (pos_25086 + chunk_len);
pos_25086 = G__25093;
continue;
} else {
var piece_len_25095 = (rest_25088 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25086,(pos_25086 + piece_len_25095)));

var G__25097 = (pos_25086 + piece_len_25095);
pos_25086 = G__25097;
continue;
...
while(true){
if((i__4790__auto___25145 < len__4789__auto___25143)){
