...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__51128 = goog.object.get(JSJodaLocale,"Locale");
if((G__51128 == null)){
return null;
} else {
return goog.object.get(G__51128,"US");
}
}catch (e51127){if((e51127 instanceof Error)){
var e = e51127;
return null;
} else {
throw e51127;
