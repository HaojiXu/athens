...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__51146 = goog.object.get(JSJodaLocale,"Locale");
if((G__51146 == null)){
return null;
} else {
return goog.object.get(G__51146,"US");
}
}catch (e51143){if((e51143 instanceof Error)){
var e = e51143;
return null;
} else {
throw e51143;
