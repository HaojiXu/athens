...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__34544 = goog.object.get(JSJodaLocale,"Locale");
if((G__34544 == null)){
return null;
} else {
return goog.object.get(G__34544,"US");
}
}catch (e34516){if((e34516 instanceof Error)){
var e = e34516;
return null;
} else {
throw e34516;
