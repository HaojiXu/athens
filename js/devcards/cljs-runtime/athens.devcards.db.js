...
var state_49183__$1 = state_49183;
var statearr_49187_49220 = state_49183__$1;
(statearr_49187_49220[(2)] = false);

(statearr_49187_49220[(1)] = (5));
...
var state_49183__$1 = state_49183;
var statearr_49192_49226 = state_49183__$1;
(statearr_49192_49226[(2)] = inst_49177);

(statearr_49192_49226[(1)] = (14));
...
var statearr_49202_49232 = state_49183__$1;
(statearr_49202_49232[(1)] = (9));

} else {
var statearr_49204_49233 = state_49183__$1;
(statearr_49204_49233[(1)] = (10));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.db !== 'undefined') && (typeof athens.devcards.db.t_athens$devcards$db49216 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.db.t_athens$devcards$db49216 = (function (meta49217){
this.meta49217 = meta49217;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.db.t_athens$devcards$db49216.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49218,meta49217__$1){
var self__ = this;
var _49218__$1 = this;
return (new athens.devcards.db.t_athens$devcards$db49216(meta49217__$1));
}));

(athens.devcards.db.t_athens$devcards$db49216.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49218){
var self__ = this;
var _49218__$1 = this;
return self__.meta49217;
}));

(athens.devcards.db.t_athens$devcards$db49216.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.db.t_athens$devcards$db49216.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48675__auto__,devcard_opts__48676__auto__){
var self__ = this;
var this__48675__auto____$1 = this;
...
(athens.devcards.db.t_athens$devcards$db49216.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta49217","meta49217",346386093,null)], null);
}));

(athens.devcards.db.t_athens$devcards$db49216.cljs$lang$type = true);

(athens.devcards.db.t_athens$devcards$db49216.cljs$lang$ctorStr = "athens.devcards.db/t_athens$devcards$db49216");

(athens.devcards.db.t_athens$devcards$db49216.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.db/t_athens$devcards$db49216");
}));

/**
 * Positional factory function for athens.devcards.db/t_athens$devcards$db49216.
 */
athens.devcards.db.__GT_t_athens$devcards$db49216 = (function athens$devcards$db$__GT_t_athens$devcards$db49216(meta49217){
return (new athens.devcards.db.t_athens$devcards$db49216(meta49217));
});

}

return (new athens.devcards.db.t_athens$devcards$db49216(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
