...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55938 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55938 = (function (meta55939){
this.meta55939 = meta55939;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55938.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55940,meta55939__$1){
var self__ = this;
var _55940__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55938(meta55939__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55938.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55940){
var self__ = this;
var _55940__$1 = this;
return self__.meta55939;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55938.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55938.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42491__auto__,devcard_opts__42492__auto__){
var self__ = this;
var this__42491__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55938.getBasis = (function (){
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55938.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55938.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55938");

(athens.devcards.all_pages.t_athens$devcards$all_pages55938.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55938");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55938.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55938 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55938(meta55939){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55938(meta55939));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55938(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
