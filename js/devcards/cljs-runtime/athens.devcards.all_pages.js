...
(athens.devcards.all_pages.t_athens$devcards$all_pages55920.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42491__auto__,devcard_opts__42492__auto__){
var self__ = this;
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55943 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55943 = (function (meta55944){
this.meta55944 = meta55944;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55943.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55945,meta55944__$1){
var self__ = this;
var _55945__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55943(meta55944__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55943.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55945){
var self__ = this;
var _55945__$1 = this;
return self__.meta55944;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55943.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55943.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42491__auto__,devcard_opts__42492__auto__){
var self__ = this;
var this__42491__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55943.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55944","meta55944",-427906087,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55943.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55943.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55943");

(athens.devcards.all_pages.t_athens$devcards$all_pages55943.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55943");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55943.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55943 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55943(meta55944){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55943(meta55944));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55943(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55975 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55975 = (function (meta55976){
this.meta55976 = meta55976;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55975.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55977,meta55976__$1){
var self__ = this;
var _55977__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55975(meta55976__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55975.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55977){
var self__ = this;
var _55977__$1 = this;
return self__.meta55976;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55975.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55975.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42491__auto__,devcard_opts__42492__auto__){
var self__ = this;
var this__42491__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55975.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55976","meta55976",-450614936,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55975.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55975.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55975");

(athens.devcards.all_pages.t_athens$devcards$all_pages55975.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55975");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55975.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55975 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55975(meta55976){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55975(meta55976));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55975(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
