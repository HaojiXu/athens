...
if((cljs.core.peek(index) < ((function (){var G__56201 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56201) : instaparse.auto_flatten_seq.true_count.call(null,G__56201));
})() - (1)))){
...
var G__56265 = v;
var G__56266 = cljs.core.pop(index);
v = G__56265;
index = G__56266;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56290 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56291 = cljs.core.next(coll__$1);
unmixed_hash = G__56290;
coll__$1 = G__56291;
continue;
} else {
return unmixed_hash;
...
var G__56292 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56293 = cljs.core.next(v);
acc = G__56292;
v = G__56293;
continue;
} else {
var G__56294 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
...
var self__ = this;
var self__ = this;
var G__56255 = (arguments.length - (1));
switch (G__56255) {
case (1):
