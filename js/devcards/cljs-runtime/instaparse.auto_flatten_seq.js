...
while(true){
if((!((coll__$1 == null)))){
var G__56284 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56285 = cljs.core.next(coll__$1);
unmixed_hash = G__56284;
coll__$1 = G__56285;
continue;
} else {
return unmixed_hash;
...
var G__56290 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56291 = cljs.core.next(v);
acc = G__56290;
v = G__56291;
continue;
} else {
var G__56292 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
...
var self__ = this;
var self__ = this;
var G__56265 = (arguments.length - (1));
switch (G__56265) {
case (1):
