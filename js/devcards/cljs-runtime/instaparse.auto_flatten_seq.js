...
var G__56269 = n__$1;
var G__56270 = cljs.core.imul(z,y);
...
var G__56295 = v;
var G__56296 = cljs.core.pop(index);
v = G__56295;
index = G__56296;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56321 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56322 = cljs.core.next(coll__$1);
unmixed_hash = G__56321;
coll__$1 = G__56322;
continue;
} else {
return unmixed_hash;
...
var G__56323 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56324 = cljs.core.next(v);
acc = G__56323;
v = G__56324;
continue;
} else {
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56253){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56253)));
}));
