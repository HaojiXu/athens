...
var G__56308 = n__$1;
var G__56309 = y;
var G__56310 = cljs.core.imul(z,z);
n = G__56308;
y = G__56309;
z = G__56310;
continue;
...
var G__56311 = n__$1;
var G__56312 = cljs.core.imul(z,y);
var G__56313 = cljs.core.imul(z,z);
n = G__56311;
y = G__56312;
z = G__56313;
continue;
...
var G__56314 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__56315 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__56314;
index__$1 = G__56315;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__56204 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56204) : instaparse.auto_flatten_seq.true_count.call(null,G__56204));
})() - (1)))){
...
var G__56316 = v;
var G__56317 = cljs.core.pop(index);
v = G__56316;
index = G__56317;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56322 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56323 = cljs.core.next(coll__$1);
unmixed_hash = G__56322;
coll__$1 = G__56323;
continue;
} else {
return unmixed_hash;
...
var G__56325 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56326 = cljs.core.next(v);
acc = G__56325;
v = G__56326;
continue;
} else {
var G__56327 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__56328 = cljs.core.next(v);
acc = G__56327;
v = G__56328;
continue;
}
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56252){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56252)));
}));
