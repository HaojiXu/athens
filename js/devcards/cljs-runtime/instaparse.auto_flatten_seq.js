...
if((cljs.core.peek(index) < ((function (){var G__56203 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56203) : instaparse.auto_flatten_seq.true_count.call(null,G__56203));
})() - (1)))){
...
while(true){
if((!((coll__$1 == null)))){
var G__56287 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56288 = cljs.core.next(coll__$1);
unmixed_hash = G__56287;
coll__$1 = G__56288;
continue;
} else {
return unmixed_hash;
...
var G__56307 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__56308 = cljs.core.next(v);
acc = G__56307;
v = G__56308;
continue;
}
