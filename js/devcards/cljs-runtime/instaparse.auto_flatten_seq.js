...
while(true){
if((!((coll__$1 == null)))){
var G__56276 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56277 = cljs.core.next(coll__$1);
unmixed_hash = G__56276;
coll__$1 = G__56277;
continue;
} else {
return unmixed_hash;
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56243){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56243)));
}));
