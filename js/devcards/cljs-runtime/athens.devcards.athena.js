...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.athena !== 'undefined') && (typeof athens.devcards.athena.t_athens$devcards$athena56086 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.athena.t_athens$devcards$athena56086 = (function (meta56087){
this.meta56087 = meta56087;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.athena.t_athens$devcards$athena56086.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_56088,meta56087__$1){
var self__ = this;
var _56088__$1 = this;
return (new athens.devcards.athena.t_athens$devcards$athena56086(meta56087__$1));
}));

(athens.devcards.athena.t_athens$devcards$athena56086.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_56088){
var self__ = this;
var _56088__$1 = this;
return self__.meta56087;
}));

(athens.devcards.athena.t_athens$devcards$athena56086.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.athena.t_athens$devcards$athena56086.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48669__auto__,devcard_opts__48670__auto__){
var self__ = this;
var this__48669__auto____$1 = this;
...
(athens.devcards.athena.t_athens$devcards$athena56086.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta56087","meta56087",-280800795,null)], null);
}));

(athens.devcards.athena.t_athens$devcards$athena56086.cljs$lang$type = true);

(athens.devcards.athena.t_athens$devcards$athena56086.cljs$lang$ctorStr = "athens.devcards.athena/t_athens$devcards$athena56086");

(athens.devcards.athena.t_athens$devcards$athena56086.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.athena/t_athens$devcards$athena56086");
}));

/**
 * Positional factory function for athens.devcards.athena/t_athens$devcards$athena56086.
 */
athens.devcards.athena.__GT_t_athens$devcards$athena56086 = (function athens$devcards$athena$__GT_t_athens$devcards$athena56086(meta56087){
return (new athens.devcards.athena.t_athens$devcards$athena56086(meta56087));
});

}

return (new athens.devcards.athena.t_athens$devcards$athena56086(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
