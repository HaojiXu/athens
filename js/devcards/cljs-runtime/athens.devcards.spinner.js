...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61692 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61692 = (function (meta61693){
this.meta61693 = meta61693;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61692.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61694,meta61693__$1){
var self__ = this;
var _61694__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61692(meta61693__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61692.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61694){
var self__ = this;
var _61694__$1 = this;
return self__.meta61693;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61692.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61692.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48669__auto__,devcard_opts__48670__auto__){
var self__ = this;
var this__48669__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61692.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61692.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61692.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61692");

(athens.devcards.spinner.t_athens$devcards$spinner61692.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61692");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61692.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61692 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61692(meta61693){
return (new athens.devcards.spinner.t_athens$devcards$spinner61692(meta61693));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61692(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
