...
var G__57380 = cljs.tools.reader.reader_types.string_push_back_reader.cljs$core$IFn$_invoke$arity$1(s);
var G__57381 = null;
var G__57382 = null;
var G__57383 = null;
return (read_string_STAR__57429.cljs$core$IFn$_invoke$arity$4 ? read_string_STAR__57429.cljs$core$IFn$_invoke$arity$4(G__57380,G__57381,G__57382,G__57383) : read_string_STAR__57429.call(null,G__57380,G__57381,G__57382,G__57383));
});
/**
...
while(true){
var G__57384 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__57384__$1 = (((G__57384 instanceof cljs.core.Keyword))?G__57384.fqn:null);
switch (G__57384__$1) {
case "rule":
var vec__57385 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57385,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57385,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__57388 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__57388) : instaparse.cfg.content.call(null,G__57388));
...
break;
case "paren":
var G__57433 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57433;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__57389 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__57390 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__57391 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__57392 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__57393 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__57394 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57384__$1)].join('')));
...
case "neg":
case "rep":
var G__57435 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57435;
continue;
...
var valid_nts_57436 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__57400_57437 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__57401_57438 = null;
var count__57402_57439 = (0);
var i__57403_57440 = (0);
while(true){
if((i__57403_57440 < count__57402_57439)){
var nt_57441 = chunk__57401_57438.cljs$core$IIndexed$_nth$arity$2(null,i__57403_57440);
if(cljs.core.truth_((valid_nts_57436.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57436.cljs$core$IFn$_invoke$arity$1(nt_57441) : valid_nts_57436.call(null,nt_57441)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57441),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57442 = seq__57400_57437;
var G__57443 = chunk__57401_57438;
var G__57444 = count__57402_57439;
var G__57445 = (i__57403_57440 + (1));
seq__57400_57437 = G__57442;
chunk__57401_57438 = G__57443;
count__57402_57439 = G__57444;
i__57403_57440 = G__57445;
continue;
} else {
var temp__5735__auto___57446 = cljs.core.seq(seq__57400_57437);
if(temp__5735__auto___57446){
var seq__57400_57447__$1 = temp__5735__auto___57446;
if(cljs.core.chunked_seq_QMARK_(seq__57400_57447__$1)){
var c__4609__auto___57448 = cljs.core.chunk_first(seq__57400_57447__$1);
var G__57449 = cljs.core.chunk_rest(seq__57400_57447__$1);
var G__57450 = c__4609__auto___57448;
var G__57451 = cljs.core.count(c__4609__auto___57448);
var G__57452 = (0);
seq__57400_57437 = G__57449;
chunk__57401_57438 = G__57450;
count__57402_57439 = G__57451;
i__57403_57440 = G__57452;
continue;
} else {
var nt_57453 = cljs.core.first(seq__57400_57447__$1);
if(cljs.core.truth_((valid_nts_57436.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57436.cljs$core$IFn$_invoke$arity$1(nt_57453) : valid_nts_57436.call(null,nt_57453)))){
} else {
...
var G__57454 = cljs.core.next(seq__57400_57447__$1);
var G__57455 = null;
var G__57456 = (0);
var G__57457 = (0);
seq__57400_57437 = G__57454;
chunk__57401_57438 = G__57455;
count__57402_57439 = G__57456;
i__57403_57440 = G__57457;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57405_57458 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57406_57459 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57407_57460 = true;
var _STAR_print_fn_STAR__temp_val__57408_57461 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57407_57460);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57408_57461);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57406_57459);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57405_57458);
}
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57411){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57414 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57415 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57415);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57416_57465 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57417_57466 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57418_57467 = true;
var _STAR_print_fn_STAR__temp_val__57419_57468 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57418_57467);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57419_57468);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57417_57466);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57416_57465);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57414);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57409){
var G__57410 = cljs.core.first(seq57409);
var seq57409__$1 = cljs.core.next(seq57409);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57410,seq57409__$1);
}));
