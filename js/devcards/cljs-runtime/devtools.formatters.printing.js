...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23821){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23822,G__23823,seq23821__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23843_SHARP_){
return (!((cljs.core.meta(p1__23843_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23850__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23865){var _e__20777__auto__ = e23865;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e23873){var _e__20777__auto__ = e23873;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23882 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23883 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23883);

try{var map__23888 = opts;
var map__23888__$1 = (((((!((map__23888 == null))))?(((((map__23888.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23888.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23888):map__23888);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23888__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23882);
}});
...
var _STAR_print_level_STAR__orig_val__23912_23936 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23913_23937 = managed_print_level_23935;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23913_23937);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23900_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23900_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23912_23936);
}} else {
job_fn();
}
