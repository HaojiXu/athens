...
var or__4185__auto____$1 = ((cljs.core.set_QMARK_(p))?(function (){var G__29282 = cljs.core.first(datom);
return (p.cljs$core$IFn$_invoke$arity$1 ? p.cljs$core$IFn$_invoke$arity$1(G__29282) : p.call(null,G__29282));
})():false);
...
var G__29304 = cljs.core.rest(pattern);
var G__29305 = cljs.core.rest(datom);
pattern = G__29304;
datom = G__29305;
continue;
} else {
...
return cljs.core.some((function (p1__29286_SHARP_){
return posh.lib.datom_matcher.datom_match_pattern_QMARK_(p1__29286_SHARP_,datom);
}),patterns);
});
posh.lib.datom_matcher.any_datoms_match_QMARK_ = (function posh$lib$datom_matcher$any_datoms_match_QMARK_(patterns,datoms){
var G__29294 = patterns;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__29294)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,G__29294)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentVector.EMPTY], null),G__29294)){
return true;
} else {
return cljs.core.some((function (p1__29290_SHARP_){
return posh.lib.datom_matcher.datom_match_QMARK_(patterns,p1__29290_SHARP_);
}),datoms);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29295_SHARP_){
return posh.lib.datom_matcher.datom_match_QMARK_(patterns,p1__29295_SHARP_);
}),datoms);
