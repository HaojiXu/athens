...
return athens.db.trim_head(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(athens.db.drop_tail(h,(function (p1__33140_SHARP_){
return (p1__33140_SHARP_ === db_before);
})),db_after),(10));
}));
} else {
return null;
