...
var G__33167 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(ch,(n - (1)));
block = G__33167;
continue;
}
break;
...
return athens.db.trim_head(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(athens.db.drop_tail(h,(function (p1__33138_SHARP_){
return (p1__33138_SHARP_ === db_before);
})),db_after),(10));
}));
} else {
return null;
