...
var map__38958__$1 = (((((!((map__38958 == null))))?(((((map__38958.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38958.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__38958):map__38958);
var style = map__38958__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38958__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38958__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__38960_39017 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__38960_39017) : style_created_handler.call(null,G__38960_39017));

var seq__38961 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__38962 = null;
var count__38963 = (0);
var i__38964 = (0);
while(true){
if((i__38964 < count__38963)){
var sub_style = chunk__38962.cljs$core$IIndexed$_nth$arity$2(null,i__38964);
var G__38972_39020 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38973_39021 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38972_39020,G__38973_39021) : stylefy.impl.styles.create_style_BANG_.call(null,G__38972_39020,G__38973_39021));


var G__39022 = seq__38961;
var G__39023 = chunk__38962;
var G__39024 = count__38963;
var G__39025 = (i__38964 + (1));
seq__38961 = G__39022;
chunk__38962 = G__39023;
count__38963 = G__39024;
i__38964 = G__39025;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__38961);
if(temp__5735__auto__){
var seq__38961__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38961__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__38961__$1);
var G__39028 = cljs.core.chunk_rest(seq__38961__$1);
var G__39029 = c__4609__auto__;
var G__39030 = cljs.core.count(c__4609__auto__);
var G__39031 = (0);
seq__38961 = G__39028;
chunk__38962 = G__39029;
count__38963 = G__39030;
i__38964 = G__39031;
continue;
} else {
var sub_style = cljs.core.first(seq__38961__$1);
var G__38976_39032 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38977_39033 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38976_39032,G__38977_39033) : stylefy.impl.styles.create_style_BANG_.call(null,G__38976_39032,G__38977_39033));


var G__39035 = cljs.core.next(seq__38961__$1);
var G__39036 = null;
var G__39037 = (0);
var G__39038 = (0);
seq__38961 = G__39035;
chunk__38962 = G__39036;
count__38963 = G__39037;
i__38964 = G__39038;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__38984_SHARP_){
return ((typeof p1__38984_SHARP_ === 'string') || ((p1__38984_SHARP_ instanceof cljs.core.Keyword)) || ((p1__38984_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__38984#] (or (string? p1__38984#) (keyword? p1__38984#) (nil? p1__38984#))) class)))"].join('')));
}
});
/**
...
var len__4789__auto___39053 = arguments.length;
var i__4790__auto___39054 = (0);
while(true){
if((i__4790__auto___39054 < len__4789__auto___39053)){
args__4795__auto__.push((arguments[i__4790__auto___39054]));

var G__39056 = (i__4790__auto___39054 + (1));
i__4790__auto___39054 = G__39056;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__38991_SHARP_,p2__38992_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__38991_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__38992_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq38993){
var G__38994 = cljs.core.first(seq38993);
var seq38993__$1 = cljs.core.next(seq38993);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38994,seq38993__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__39001){
...
var styles_39063__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__39005_39064 = cljs.core.seq(styles_39063__$1);
var chunk__39006_39065 = null;
var count__39007_39066 = (0);
var i__39008_39067 = (0);
while(true){
if((i__39008_39067 < count__39007_39066)){
var style_39068 = chunk__39006_39065.cljs$core$IIndexed$_nth$arity$2(null,i__39008_39067);
stylefy.impl.styles.use_style_BANG_(style_39068,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___39070 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_39068));
if(cljs.core.truth_(temp__5735__auto___39070)){
var sub_styles_39072 = temp__5735__auto___39070;
...
var G__39073 = seq__39005_39064;
var G__39074 = chunk__39006_39065;
var G__39075 = count__39007_39066;
var G__39076 = (i__39008_39067 + (1));
seq__39005_39064 = G__39073;
chunk__39006_39065 = G__39074;
count__39007_39066 = G__39075;
i__39008_39067 = G__39076;
continue;
} else {
var temp__5735__auto___39078 = cljs.core.seq(seq__39005_39064);
if(temp__5735__auto___39078){
var seq__39005_39079__$1 = temp__5735__auto___39078;
if(cljs.core.chunked_seq_QMARK_(seq__39005_39079__$1)){
var c__4609__auto___39080 = cljs.core.chunk_first(seq__39005_39079__$1);
var G__39081 = cljs.core.chunk_rest(seq__39005_39079__$1);
var G__39082 = c__4609__auto___39080;
var G__39083 = cljs.core.count(c__4609__auto___39080);
var G__39084 = (0);
seq__39005_39064 = G__39081;
chunk__39006_39065 = G__39082;
count__39007_39066 = G__39083;
i__39008_39067 = G__39084;
continue;
} else {
var style_39087 = cljs.core.first(seq__39005_39079__$1);
stylefy.impl.styles.use_style_BANG_(style_39087,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___39088__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_39087));
if(cljs.core.truth_(temp__5735__auto___39088__$1)){
var sub_styles_39089 = temp__5735__auto___39088__$1;
...
var G__39092 = cljs.core.next(seq__39005_39079__$1);
var G__39093 = null;
var G__39094 = (0);
var G__39095 = (0);
seq__39005_39064 = G__39092;
chunk__39006_39065 = G__39093;
count__39007_39066 = G__39094;
i__39008_39067 = G__39095;
continue;
}
} else {
}
