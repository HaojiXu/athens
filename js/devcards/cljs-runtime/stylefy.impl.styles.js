...
var G__45187_45258 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__45187_45258) : style_created_handler.call(null,G__45187_45258));
...
var G__45201_45260 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__45202_45261 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__45201_45260,G__45202_45261) : stylefy.impl.styles.create_style_BANG_.call(null,G__45201_45260,G__45202_45261));


var G__45264 = seq__45188;
var G__45265 = chunk__45189;
var G__45266 = count__45190;
var G__45267 = (i__45191 + (1));
seq__45188 = G__45264;
chunk__45189 = G__45265;
count__45190 = G__45266;
i__45191 = G__45267;
continue;
} else {
...
var G__45205_45274 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__45206_45275 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__45205_45274,G__45206_45275) : stylefy.impl.styles.create_style_BANG_.call(null,G__45205_45274,G__45206_45275));
...
var len__4789__auto___45295 = arguments.length;
var i__4790__auto___45296 = (0);
while(true){
if((i__4790__auto___45296 < len__4789__auto___45295)){
args__4795__auto__.push((arguments[i__4790__auto___45296]));

var G__45298 = (i__4790__auto___45296 + (1));
i__4790__auto___45296 = G__45298;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__45236_SHARP_,p2__45238_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__45236_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__45238_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
var styles_45308__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__45249_45309 = cljs.core.seq(styles_45308__$1);
var chunk__45250_45310 = null;
var count__45251_45311 = (0);
var i__45252_45312 = (0);
while(true){
if((i__45252_45312 < count__45251_45311)){
var style_45314 = chunk__45250_45310.cljs$core$IIndexed$_nth$arity$2(null,i__45252_45312);
stylefy.impl.styles.use_style_BANG_(style_45314,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___45316 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_45314));
if(cljs.core.truth_(temp__5735__auto___45316)){
var sub_styles_45318 = temp__5735__auto___45316;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_45318,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__45320 = seq__45249_45309;
var G__45321 = chunk__45250_45310;
var G__45322 = count__45251_45311;
var G__45323 = (i__45252_45312 + (1));
seq__45249_45309 = G__45320;
chunk__45250_45310 = G__45321;
count__45251_45311 = G__45322;
i__45252_45312 = G__45323;
continue;
} else {
var temp__5735__auto___45325 = cljs.core.seq(seq__45249_45309);
if(temp__5735__auto___45325){
var seq__45249_45326__$1 = temp__5735__auto___45325;
if(cljs.core.chunked_seq_QMARK_(seq__45249_45326__$1)){
var c__4609__auto___45327 = cljs.core.chunk_first(seq__45249_45326__$1);
var G__45328 = cljs.core.chunk_rest(seq__45249_45326__$1);
var G__45329 = c__4609__auto___45327;
var G__45330 = cljs.core.count(c__4609__auto___45327);
var G__45331 = (0);
seq__45249_45309 = G__45328;
chunk__45250_45310 = G__45329;
count__45251_45311 = G__45330;
i__45252_45312 = G__45331;
continue;
} else {
var style_45333 = cljs.core.first(seq__45249_45326__$1);
stylefy.impl.styles.use_style_BANG_(style_45333,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___45334__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_45333));
if(cljs.core.truth_(temp__5735__auto___45334__$1)){
var sub_styles_45336 = temp__5735__auto___45334__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_45336,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__45338 = cljs.core.next(seq__45249_45326__$1);
var G__45339 = null;
var G__45340 = (0);
var G__45341 = (0);
seq__45249_45309 = G__45338;
chunk__45250_45310 = G__45339;
count__45251_45311 = G__45340;
i__45252_45312 = G__45341;
continue;
}
} else {
}
