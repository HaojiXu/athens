...
var entity_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__29370_SHARP_){
return ((cljs.core.map_QMARK_(p1__29370_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),p1__29370_SHARP_)));
}),pull_pattern);
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__29410,pull_pattern,ent_id){
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__29424 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__29424.cljs$core$IFn$_invoke$arity$2 ? fexpr__29424.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__29424.call(null,db,ent_id));
})());
