...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__29381,pull_pattern,ent_id){
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__29398 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__29398.cljs$core$IFn$_invoke$arity$2 ? fexpr__29398.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__29398.call(null,db,ent_id));
})());
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29415__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29415__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29415__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
...
var fexpr__29425 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__29425.cljs$core$IFn$_invoke$arity$2 ? fexpr__29425.cljs$core$IFn$_invoke$arity$2(db,p1__29407_SHARP_) : fexpr__29425.call(null,db,p1__29407_SHARP_));
}),ent_ids);
