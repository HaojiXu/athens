...
posh.core.after_transact = (function posh$core$after_transact(p__31370,conns_results){
...
var posh_tree = map__31371__$1;
var conns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31371__$1,new cljs.core.Keyword(null,"conns","conns",-1475268193));
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31371__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var dbs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31371__$1,new cljs.core.Keyword(null,"dbs","dbs",1889628467));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31371__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31371__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var new_dbs = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,(function (){var iter__4582__auto__ = (function posh$core$after_transact_$_iter__31373(s__31374){
return (new cljs.core.LazySeq(null,(function (){
var s__31374__$1 = s__31374;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__31374__$1);
if(temp__5735__auto__){
var s__31374__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31374__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__31374__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__31376 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__31375 = (0);
while(true){
if((i__31375 < size__4581__auto__)){
var vec__31379 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__31375);
...
cljs.core.chunk_append(b__31376,(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn))?cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,posh.lib.db.generate_initial_db.cljs$core$IFn$_invoke$arity$4(dcfg,conn,cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,db_id),new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn)))]):cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,cljs.core.get.cljs$core$IFn$_invoke$arity$2(dbs,db_id)])));

var G__31406 = (i__31375 + (1));
i__31375 = G__31406;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31376),posh$core$after_transact_$_iter__31373(cljs.core.chunk_rest(s__31374__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31376),null);
}
} else {
var vec__31382 = cljs.core.first(s__31374__$2);
...
return cljs.core.cons((cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn))?cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,posh.lib.db.generate_initial_db.cljs$core$IFn$_invoke$arity$4(dcfg,conn,cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,db_id),new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn)))]):cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,cljs.core.get.cljs$core$IFn$_invoke$arity$2(dbs,db_id)])),posh$core$after_transact_$_iter__31373(cljs.core.rest(s__31374__$2)));
}
} else {
return null;
}
...
posh.core.process_tx_BANG_ = (function posh$core$process_tx_BANG_(p__31393){
...
var posh_tree = map__31394__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31394__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var txs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31394__$1,new cljs.core.Keyword(null,"txs","txs",2056038378));
var conns_results = cljs.core.reduce_kv((function (m,conn,tx){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,conn,(function (){var fexpr__31396 = new cljs.core.Keyword(null,"transact!","transact!",-822725810).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31396.cljs$core$IFn$_invoke$arity$2 ? fexpr__31396.cljs$core$IFn$_invoke$arity$2(conn,tx) : fexpr__31396.call(null,conn,tx));
})());
