...
posh.core.after_transact = (function posh$core$after_transact(p__31372,conns_results){
...
var posh_tree = map__31373__$1;
var conns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31373__$1,new cljs.core.Keyword(null,"conns","conns",-1475268193));
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31373__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var dbs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31373__$1,new cljs.core.Keyword(null,"dbs","dbs",1889628467));
var filters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31373__$1,new cljs.core.Keyword(null,"filters","filters",974726919));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31373__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var new_dbs = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,(function (){var iter__4582__auto__ = (function posh$core$after_transact_$_iter__31375(s__31376){
return (new cljs.core.LazySeq(null,(function (){
var s__31376__$1 = s__31376;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__31376__$1);
if(temp__5735__auto__){
var s__31376__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31376__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__31376__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__31378 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__31377 = (0);
while(true){
if((i__31377 < size__4581__auto__)){
var vec__31379 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__31377);
var db_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31379,(0),null);
var conn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31379,(1),null);
cljs.core.chunk_append(b__31378,(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn))?cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,posh.lib.db.generate_initial_db.cljs$core$IFn$_invoke$arity$4(dcfg,conn,cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,db_id),new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn)))]):cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,cljs.core.get.cljs$core$IFn$_invoke$arity$2(dbs,db_id)])));

var G__31406 = (i__31377 + (1));
i__31377 = G__31406;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31378),posh$core$after_transact_$_iter__31375(cljs.core.chunk_rest(s__31376__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31378),null);
}
} else {
var vec__31382 = cljs.core.first(s__31376__$2);
var db_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31382,(0),null);
var conn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31382,(1),null);
return cljs.core.cons((cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn))?cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,posh.lib.db.generate_initial_db.cljs$core$IFn$_invoke$arity$4(dcfg,conn,cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,db_id),new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn)))]):cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,cljs.core.get.cljs$core$IFn$_invoke$arity$2(dbs,db_id)])),posh$core$after_transact_$_iter__31375(cljs.core.rest(s__31376__$2)));
}
} else {
return null;
}
...
var changed_cache = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (changed,p__31389){
var vec__31390 = p__31389;
var db_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31390,(0),null);
var conn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31390,(1),null);
...
posh.core.process_tx_BANG_ = (function posh$core$process_tx_BANG_(p__31394){
var map__31395 = p__31394;
var map__31395__$1 = (((((!((map__31395 == null))))?(((((map__31395.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31395.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__31395):map__31395);
var posh_tree = map__31395__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31395__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var txs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31395__$1,new cljs.core.Keyword(null,"txs","txs",2056038378));
var conns_results = cljs.core.reduce_kv((function (m,conn,tx){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,conn,(function (){var fexpr__31397 = new cljs.core.Keyword(null,"transact!","transact!",-822725810).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31397.cljs$core$IFn$_invoke$arity$2 ? fexpr__31397.cljs$core$IFn$_invoke$arity$2(conn,tx) : fexpr__31397.call(null,conn,tx));
})());
