...
var G__45590 = seq__45381_45585;
var G__45591 = chunk__45382_45586;
var G__45592 = count__45383_45587;
var G__45593 = (i__45384_45588 + (1));
seq__45381_45585 = G__45590;
chunk__45382_45586 = G__45591;
count__45383_45587 = G__45592;
i__45384_45588 = G__45593;
continue;
} else {
var temp__5735__auto___45594 = cljs.core.seq(seq__45381_45585);
if(temp__5735__auto___45594){
var seq__45381_45595__$1 = temp__5735__auto___45594;
if(cljs.core.chunked_seq_QMARK_(seq__45381_45595__$1)){
var c__4609__auto___45596 = cljs.core.chunk_first(seq__45381_45595__$1);
var G__45597 = cljs.core.chunk_rest(seq__45381_45595__$1);
var G__45598 = c__4609__auto___45596;
var G__45599 = cljs.core.count(c__4609__auto___45596);
var G__45600 = (0);
seq__45381_45585 = G__45597;
chunk__45382_45586 = G__45598;
count__45383_45587 = G__45599;
i__45384_45588 = G__45600;
continue;
} else {
var f_45601 = cljs.core.first(seq__45381_45595__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  ",f_45601], 0));


var G__45602 = cljs.core.next(seq__45381_45595__$1);
var G__45603 = null;
var G__45604 = (0);
var G__45605 = (0);
seq__45381_45585 = G__45602;
chunk__45382_45586 = G__45603;
count__45383_45587 = G__45604;
i__45384_45588 = G__45605;
continue;
}
} else {
}
...
var vec__45400_45613 = chunk__45386_45610.cljs$core$IIndexed$_nth$arity$2(null,i__45388_45612);
var name_45614 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45400_45613,(0),null);
var map__45403_45615 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45400_45613,(1),null);
var map__45403_45616__$1 = (((((!((map__45403_45615 == null))))?(((((map__45403_45615.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45403_45615.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45403_45615):map__45403_45615);
var doc_45617 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45403_45616__$1,new cljs.core.Keyword(null,"doc","doc",1913296891));
var arglists_45618 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45403_45616__$1,new cljs.core.Keyword(null,"arglists","arglists",1661989754));
cljs.core.println();
...
chunk__45386_45610 = G__45638;
count__45387_45611 = G__45639;
i__45388_45612 = G__45640;
continue;
}
} else {
}
...
var map__45425 = datafied_throwable;
...
var via = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45425__$1,new cljs.core.Keyword(null,"via","via",-1904457336));
var trace = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45425__$1,new cljs.core.Keyword(null,"trace","trace",-1082747415));
var phase = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45425__$1,new cljs.core.Keyword(null,"phase","phase",575722892),new cljs.core.Keyword(null,"execution","execution",253283524));
var map__45426 = cljs.core.last(via);
var map__45426__$1 = (((((!((map__45426 == null))))?(((((map__45426.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45426.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45426):map__45426);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45426__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45426__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45426__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var map__45427 = data;
...
var problems = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45427__$1,new cljs.core.Keyword("cljs.spec.alpha","problems","cljs.spec.alpha/problems",447400814));
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45427__$1,new cljs.core.Keyword("cljs.spec.alpha","fn","cljs.spec.alpha/fn",408600443));
var caller = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45427__$1,new cljs.core.Keyword("cljs.spec.test.alpha","caller","cljs.spec.test.alpha/caller",-398302390));
var map__45428 = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.first(via));
...
var top_data = map__45428__$1;
var source = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45428__$1,new cljs.core.Keyword("clojure.error","source","clojure.error/source",-2011936397));
...
var fexpr__45486 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["NO_SOURCE_PATH",null,"NO_SOURCE_FILE",null], null), null);
return (fexpr__45486.cljs$core$IFn$_invoke$arity$1 ? fexpr__45486.cljs$core$IFn$_invoke$arity$1(p1__45420_SHARP_) : fexpr__45486.call(null,p1__45420_SHARP_));
}
...
var G__45493 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("clojure.error","class","clojure.error/class",278435890),type], null);
var G__45493__$1 = (cljs.core.truth_(err_line)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45493,new cljs.core.Keyword("clojure.error","line","clojure.error/line",-1816287471),err_line):G__45493);
var G__45493__$2 = (cljs.core.truth_(message)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45493__$1,new cljs.core.Keyword("clojure.error","cause","clojure.error/cause",-1879175742),message):G__45493__$1);
var G__45493__$3 = (cljs.core.truth_((function (){var or__4185__auto__ = fn;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45493__$2,new cljs.core.Keyword("clojure.error","symbol","clojure.error/symbol",1544821994),(function (){var or__4185__auto__ = fn;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
var G__45493__$4 = (cljs.core.truth_(file__$1)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45493__$3,new cljs.core.Keyword("clojure.error","source","clojure.error/source",-2011936397),file__$1):G__45493__$3);
if(cljs.core.truth_(problems)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45493__$4,new cljs.core.Keyword("clojure.error","spec","clojure.error/spec",2055032595),data);
} else {
return G__45493__$4;
}
...
var triage_data = map__45515__$1;
var phase = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45515__$1,new cljs.core.Keyword("clojure.error","phase","clojure.error/phase",275140358));
...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45515__$1,new cljs.core.Keyword("clojure.error","line","clojure.error/line",-1816287471));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45515__$1,new cljs.core.Keyword("clojure.error","column","clojure.error/column",304721553));
var symbol = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45515__$1,new cljs.core.Keyword("clojure.error","symbol","clojure.error/symbol",1544821994));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45515__$1,new cljs.core.Keyword("clojure.error","class","clojure.error/class",278435890));
var cause = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45515__$1,new cljs.core.Keyword("clojure.error","cause","clojure.error/cause",-1879175742));
var spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45515__$1,new cljs.core.Keyword("clojure.error","spec","clojure.error/spec",2055032595));
...
var G__45531 = phase;
var G__45531__$1 = (((G__45531 instanceof cljs.core.Keyword))?G__45531.fqn:null);
switch (G__45531__$1) {
case "read-source":
...
var _STAR_print_newline_STAR__orig_val__45574_45674 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__45575_45675 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__45576_45676 = true;
var _STAR_print_fn_STAR__temp_val__45577_45677 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__45576_45676);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__45577_45677);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__45575_45675);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__45574_45674);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45531__$1)].join('')));
