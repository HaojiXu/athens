...
var G__24196_24199 = Error;
var target__20857__auto___24200 = G__24196_24199;
if(cljs.core.truth_(target__20857__auto___24200)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24196_24199)].join(''),"\n","target__20857__auto__"].join('')));
}
