...
var G__46352 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46352;
continue;
} else {
...
var G__46353 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46353;
continue;
} else {
var G__46354 = clojure.zip.next(loc);
loc = G__46354;
continue;
