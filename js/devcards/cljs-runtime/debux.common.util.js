...
var G__51475 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51476 = clojure.zip.next(loc);
loc = G__51476;
continue;
}
}
...
return (function() { 
var G__51501__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51469 = quoted_form;
var G__51470 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51469,G__51470) : debux.common.util.remove_d.call(null,G__51469,G__51470));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__51501 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__51502__i = 0, G__51502__a = new Array(arguments.length -  0);
while (G__51502__i < G__51502__a.length) {G__51502__a[G__51502__i] = arguments[G__51502__i + 0]; ++G__51502__i;}
  arg = new cljs.core.IndexedSeq(G__51502__a,0,null);
} 
return G__51501__delegate.call(this,arg);};
G__51501.cljs$lang$maxFixedArity = 0;
G__51501.cljs$lang$applyTo = (function (arglist__51503){
var arg = cljs.core.seq(arglist__51503);
return G__51501__delegate(arg);
});
G__51501.cljs$core$IFn$_invoke$arity$variadic = G__51501__delegate;
return G__51501;
})()
;
});
...
var G__51504 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__51504;
continue;
} else {
