...
var G__51465 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51427,(0),null);
...
var G__51497 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51497;
continue;
} else {
var G__51498 = clojure.zip.next(loc);
loc = G__51498;
continue;
