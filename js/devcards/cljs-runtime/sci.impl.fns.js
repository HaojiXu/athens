...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59015,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__59016__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59016__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59016__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59016__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59016__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59059 = cljs.core.next(args__$1);
var G__59060 = cljs.core.next(params__$1);
var G__59061 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59059;
params__$1 = G__59060;
ret = G__59061;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__59023 = ctx__$1;
var G__59024 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__59023,G__59024) : interpret.call(null,G__59023,G__59024));
...
var vec__59025 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59025,(0),null);
var vec__59028 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59025,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59028,(0),null);
var G__59064 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__59064;
continue;
} else {
var G__59065 = recur_val;
args = G__59065;
continue;
}
} else {
...
while (G__59066__i < G__59066__a.length) {G__59066__a[G__59066__i] = arguments[G__59066__i + 0]; ++G__59066__i;}
  args = new cljs.core.IndexedSeq(G__59066__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59067){
var args = cljs.core.seq(arglist__59067);
...
var map__59033 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59033__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59033__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59041){
...
var f = map__59042__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59042__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59042__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__59069__delegate = function (args){
...
while (G__59070__i < G__59070__a.length) {G__59070__a[G__59070__i] = arguments[G__59070__i + 0]; ++G__59070__i;}
  args = new cljs.core.IndexedSeq(G__59070__a,0,null);
} 
return G__59069__delegate.call(this,args);};
G__59069.cljs$lang$maxFixedArity = 0;
G__59069.cljs$lang$applyTo = (function (arglist__59071){
var args = cljs.core.seq(arglist__59071);
return G__59069__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59038_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59038_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__59072__delegate = function (args){
...
var G__59072 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__59072__delegate.call(this,args);};
G__59072.cljs$lang$maxFixedArity = 0;
G__59072.cljs$lang$applyTo = (function (arglist__59075){
var args = cljs.core.seq(arglist__59075);
return G__59072__delegate(args);
});
G__59072.cljs$core$IFn$_invoke$arity$variadic = G__59072__delegate;
return G__59072;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59039_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59039_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
