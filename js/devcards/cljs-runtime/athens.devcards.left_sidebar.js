...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538 = (function (meta61539){
this.meta61539 = meta61539;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61540,meta61539__$1){
var self__ = this;
var _61540__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538(meta61539__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61540){
var self__ = this;
var _61540__$1 = this;
return self__.meta61539;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42483__auto__,devcard_opts__42484__auto__){
var self__ = this;
...
var G__61541 = athens.db.dsdb;
var G__61542 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__61541,G__61542) : posh.reagent.transact_BANG_.call(null,G__61541,G__61542));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61538");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61538");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61538.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61538 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61538(meta61539){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538(meta61539));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61538(null));
})()
