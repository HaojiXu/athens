...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$iter__61585(s__61586){
return (new cljs.core.LazySeq(null,(function (){
var s__61586__$1 = s__61586;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61586__$1);
if(temp__5735__auto__){
var s__61586__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61586__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61586__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61588 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61587 = (0);
while(true){
if((i__61587 < size__4581__auto__)){
var vec__61589 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61587);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61589,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61589,(1),null);
cljs.core.chunk_append(b__61588,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)));

var G__61639 = (i__61587 + (1));
i__61587 = G__61639;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61588),athens$devcards$sci_boxes$iter__61585(cljs.core.chunk_rest(s__61586__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61588),null);
}
} else {
var vec__61592 = cljs.core.first(s__61586__$2);
...
return cljs.core.some((function (p__61595){
var vec__61596 = p__61595;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61596,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61596,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__61599){
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61600__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
return clojure.string.starts_with_QMARK_(str_content,":sci");
});
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__61602,parent){
...
}catch (e61605){if((e61605 instanceof Error)){
var e = e61605;
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__61606_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__61606_SHARP_) : visited.call(null,p1__61606_SHARP_)))){
...
var G__61640 = boxes_SINGLEQUOTE_;
var G__61641 = visited_SINGLEQUOTE_;
var G__61642 = id_SINGLEQUOTE_;
boxes__$1 = G__61640;
visited = G__61641;
id = G__61642;
continue;
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__61608,idx,id){
...
var box = map__61609__$1;
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61609__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__61611,id){
...
var state = map__61612__$1;
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61612__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61612__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__61614,id){
...
var map__61617 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__61620_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__61620_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
...
var vec__61623 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61623,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61623,(1),null);
...
var map__61628 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var map__61629 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61629__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__61626_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__61626_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__61627_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__61627_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__61632(s__61633){
return (new cljs.core.LazySeq(null,(function (){
var s__61633__$1 = s__61633;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61633__$1);
if(temp__5735__auto__){
var s__61633__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61633__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61633__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61635 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61634 = (0);
while(true){
if((i__61634 < size__4581__auto__)){
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61634);
cljs.core.chunk_append(b__61635,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__61644 = (i__61634 + (1));
i__61634 = G__61644;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61635),athens$devcards$sci_boxes$box_component_$_iter__61632(cljs.core.chunk_rest(s__61633__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61635),null);
}
} else {
var id__$1 = cljs.core.first(s__61633__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__61632(cljs.core.rest(s__61633__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636 = (function (meta61637){
this.meta61637 = meta61637;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61638,meta61637__$1){
var self__ = this;
var _61638__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636(meta61637__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61638){
var self__ = this;
var _61638__$1 = this;
return self__.meta61637;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42483__auto__,devcard_opts__42484__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636.getBasis = (function (){
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61636");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61636");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61636.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes61636 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes61636(meta61637){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636(meta61637));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61636(null));
})()
