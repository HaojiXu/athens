...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$iter__61611(s__61612){
return (new cljs.core.LazySeq(null,(function (){
var s__61612__$1 = s__61612;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61612__$1);
if(temp__5735__auto__){
var s__61612__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61612__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61612__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61614 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61613 = (0);
while(true){
if((i__61613 < size__4581__auto__)){
var vec__61615 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61613);
...
cljs.core.chunk_append(b__61614,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)));

var G__61665 = (i__61613 + (1));
i__61613 = G__61665;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61614),athens$devcards$sci_boxes$iter__61611(cljs.core.chunk_rest(s__61612__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61614),null);
}
} else {
var vec__61618 = cljs.core.first(s__61612__$2);
...
return cljs.core.some((function (p__61621){
var vec__61622 = p__61621;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61622,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61622,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__61625){
...
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__61628,parent){
...
}catch (e61631){if((e61631 instanceof Error)){
var e = e61631;
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__61634,idx,id){
...
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61635__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__61637,id){
...
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61638__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__61640,id){
...
var map__61643 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var G__61645 = k;
var G__61645__$1 = (((G__61645 instanceof cljs.core.Keyword))?G__61645.fqn:null);
switch (G__61645__$1) {
case "return":
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__61646_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__61646_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
athens.devcards.sci_boxes.sci_result_component = (function athens$devcards$sci_boxes$sci_result_component(result){
if(cljs.core.truth_(result)){
var map__61647 = result;
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61647__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__61649 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61649,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61649,(1),null);
...
var map__61654 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61654__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var map__61655 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var box = map__61655__$1;
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61655__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61655__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61655__$1,new cljs.core.Keyword(null,"result","result",1415092211));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__61652_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__61652_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__61653_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__61653_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__61658(s__61659){
return (new cljs.core.LazySeq(null,(function (){
...
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61660);
cljs.core.chunk_append(b__61661,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__61673 = (i__61660 + (1));
i__61660 = G__61673;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61661),athens$devcards$sci_boxes$box_component_$_iter__61658(cljs.core.chunk_rest(s__61659__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61661),null);
}
} else {
var id__$1 = cljs.core.first(s__61659__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__61658(cljs.core.rest(s__61659__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662 = (function (meta61663){
this.meta61663 = meta61663;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61664,meta61663__$1){
var self__ = this;
var _61664__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662(meta61663__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61664){
var self__ = this;
var _61664__$1 = this;
return self__.meta61663;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__48668__auto__,devcard_opts__48669__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662.getBasis = (function (){
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61662");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61662");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61662.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes61662 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes61662(meta61663){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662(meta61663));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61662(null));
})()
