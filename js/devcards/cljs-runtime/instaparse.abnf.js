...
var len__4789__auto___57957 = arguments.length;
var i__4790__auto___57958 = (0);
while(true){
if((i__4790__auto___57958 < len__4789__auto___57957)){
args__4795__auto__.push((arguments[i__4790__auto___57958]));

var G__57959 = (i__4790__auto___57958 + (1));
i__4790__auto___57958 = G__57959;
continue;
} else {
}
break;
...
var vec__57890 = nums;
var lo = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57890,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57890,(1),null);
var hi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57890,(2),null);
return instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$2(lo,hi);
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(instaparse.combinators_source.cat,(function (){var iter__4582__auto__ = (function instaparse$abnf$iter__57893(s__57894){
...
var n = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57895);
cljs.core.chunk_append(b__57896,instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n));

var G__57963 = (i__57895 + (1));
i__57895 = G__57963;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57896),instaparse$abnf$iter__57893(cljs.core.chunk_rest(s__57894__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57896),null);
}
} else {
var n = cljs.core.first(s__57894__$2);
return cljs.core.cons(instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n),instaparse$abnf$iter__57893(cljs.core.rest(s__57894__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(instaparse.abnf.get_char_combinator.cljs$lang$applyTo = (function (seq57880){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq57880));
}));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$abnf$project_$_iter__57897(s__57898){
return (new cljs.core.LazySeq(null,(function (){
var s__57898__$1 = s__57898;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__57898__$1);
if(temp__5735__auto__){
var s__57898__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57898__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__57898__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__57900 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__57899 = (0);
while(true){
if((i__57899 < size__4581__auto__)){
var k = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57899);
if(cljs.core.contains_QMARK_(m,k)){
cljs.core.chunk_append(b__57900,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null));

var G__57968 = (i__57899 + (1));
i__57899 = G__57968;
continue;
} else {
var G__57969 = (i__57899 + (1));
i__57899 = G__57969;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57900),instaparse$abnf$project_$_iter__57897(cljs.core.chunk_rest(s__57898__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57900),null);
}
} else {
var k = cljs.core.first(s__57898__$2);
if(cljs.core.contains_QMARK_(m,k)){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null),instaparse$abnf$project_$_iter__57897(cljs.core.rest(s__57898__$2)));
} else {
var G__57970 = cljs.core.rest(s__57898__$2);
s__57898__$1 = G__57970;
continue;
}
}
} else {
...
var G__57905 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cs);
var G__57906 = (2);
return (instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$2 ? instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$2(G__57905,G__57906) : instaparse.abnf.parse_int.call(null,G__57905,G__57906));
};
...
var G__57980__delegate = function (rest__57903_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57903_SHARP_))));
} else {
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57903_SHARP_)));
}
};
...
while (G__57982__i < G__57982__a.length) {G__57982__a[G__57982__i] = arguments[G__57982__i + 0]; ++G__57982__i;}
  rest__57903_SHARP_ = new cljs.core.IndexedSeq(G__57982__a,0,null);
} 
return G__57980__delegate.call(this,rest__57903_SHARP_);};
G__57980.cljs$lang$maxFixedArity = 0;
G__57980.cljs$lang$applyTo = (function (arglist__57983){
var rest__57903_SHARP_ = cljs.core.seq(arglist__57983);
return G__57980__delegate(rest__57903_SHARP_);
});
G__57980.cljs$core$IFn$_invoke$arity$variadic = G__57980__delegate;
return G__57980;
})()
,(function() { 
var G__57984__delegate = function (rest__57904_SHARP_){
var G__57907 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57904_SHARP_);
...
while (G__57985__i < G__57985__a.length) {G__57985__a[G__57985__i] = arguments[G__57985__i + 0]; ++G__57985__i;}
  rest__57904_SHARP_ = new cljs.core.IndexedSeq(G__57985__a,0,null);
} 
return G__57984__delegate.call(this,rest__57904_SHARP_);};
G__57984.cljs$lang$maxFixedArity = 0;
G__57984.cljs$lang$applyTo = (function (arglist__57986){
var rest__57904_SHARP_ = cljs.core.seq(arglist__57986);
return G__57984__delegate(rest__57904_SHARP_);
});
...
G__57990.cljs$lang$applyTo = (function (arglist__57996){
var cs = cljs.core.seq(arglist__57996);
...
,(function() { 
var G__58000__delegate = function (rest__57902_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57902_SHARP_)));
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57902_SHARP_));
}
};
...
while (G__58002__i < G__58002__a.length) {G__58002__a[G__58002__i] = arguments[G__58002__i + 0]; ++G__58002__i;}
  rest__57902_SHARP_ = new cljs.core.IndexedSeq(G__58002__a,0,null);
} 
return G__58000__delegate.call(this,rest__57902_SHARP_);};
G__58000.cljs$lang$maxFixedArity = 0;
G__58000.cljs$lang$applyTo = (function (arglist__58003){
var rest__57902_SHARP_ = cljs.core.seq(arglist__58003);
return G__58000__delegate(rest__57902_SHARP_);
});
...
while (G__58010__i < G__58010__a.length) {G__58010__a[G__58010__i] = arguments[G__58010__i + 0]; ++G__58010__i;}
  items = new cljs.core.IndexedSeq(G__58010__a,0,null);
} 
return G__58004__delegate.call(this,items);};
G__58004.cljs$lang$maxFixedArity = 0;
G__58004.cljs$lang$applyTo = (function (arglist__58011){
var items = cljs.core.seq(arglist__58011);
...
var G__58012__delegate = function (cs){
...
while (G__58013__i < G__58013__a.length) {G__58013__a[G__58013__i] = arguments[G__58013__i + 0]; ++G__58013__i;}
  cs = new cljs.core.IndexedSeq(G__58013__a,0,null);
} 
return G__58012__delegate.call(this,cs);};
G__58012.cljs$lang$maxFixedArity = 0;
G__58012.cljs$lang$applyTo = (function (arglist__58014){
var cs = cljs.core.seq(arglist__58014);
return G__58012__delegate(cs);
});
...
var _STAR_case_insensitive_literals_STAR__orig_val__57918 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57919 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57919);
...
var _STAR_print_newline_STAR__orig_val__57920_58019 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57921_58020 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57922_58021 = true;
var _STAR_print_fn_STAR__temp_val__57923_58022 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57922_58021);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57923_58022);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57921_58020);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57920_58019);
}
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57918);
}}));
...
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57924_58023 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57925_58024 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57926_58025 = true;
var _STAR_print_fn_STAR__temp_val__57927_58026 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57926_58025);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57927_58026);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rule_tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57925_58024);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57924_58023);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
