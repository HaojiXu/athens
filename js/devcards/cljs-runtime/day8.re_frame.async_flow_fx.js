 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__61741){
var vec__61742 = p__61741;
var seq__61743 = cljs.core.seq(vec__61742);
var first__61744 = cljs.core.first(seq__61743);
var seq__61743__$1 = cljs.core.next(seq__61743);
var k = first__61744;
var ks = seq__61743__$1;
var keys = vec__61742;
if(ks){
...
var G__61746 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__61747 = now_seen_events;
var fexpr__61745 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__61745.cljs$core$IFn$_invoke$arity$2 ? fexpr__61745.cljs$core$IFn$_invoke$arity$2(G__61746,G__61747) : fexpr__61745.call(null,G__61746,G__61747));
...
var G__61748 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61749 = "async-flow: got bad value for :when - ";
var G__61750 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61748,G__61749,G__61750) : re_frame.core.console.call(null,G__61748,G__61749,G__61750));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__61751){
var map__61752 = p__61751;
...
var rule = map__61752__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61752__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61752__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61752__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61752__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61752__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61752__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61752__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__61755 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__61756 = rule;
...
var G__61757 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__61757__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61757,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__61757);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61757__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__61757__$1;
}
...
var G__61761 = "async-flow: dispatch-fn must return a seq of events ";
var G__61762 = rule;
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__61763){
var map__61764 = p__61763;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61764__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61764__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61764__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61764__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__61766,p__61767){
var map__61768 = p__61766;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61768__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__61769 = p__61767;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61769,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61769,(1),null);
var event_v = vec__61769;
var pred__61773 = cljs.core._EQ_;
var expr__61774 = event_type;
if(cljs.core.truth_((function (){var G__61776 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__61777 = expr__61774;
return (pred__61773.cljs$core$IFn$_invoke$arity$2 ? pred__61773.cljs$core$IFn$_invoke$arity$2(G__61776,G__61777) : pred__61773.call(null,G__61776,G__61777));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__61778 = db;
var G__61779 = cljs.core.PersistentHashSet.EMPTY;
var G__61780 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__61778,G__61779,G__61780) : set_state.call(null,G__61778,G__61779,G__61780));
...
var vec__61781 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61781,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61781,(1),null);
var map__61784 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61784__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61784__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__61786 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61786,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61786,(1),null);
...
var G__61789 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61789) : re_frame.core.dispatch.call(null,G__61789));
});
var G__61790_61792 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__61791_61793 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__61790_61792,G__61791_61793) : re_frame.core.reg_fx.call(null,G__61790_61792,G__61791_61793));
