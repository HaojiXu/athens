...
var pattern_28621 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28621,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var vec__28564 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28564,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28564,(1),null);
...
case "expand-rev":
var G__28664 = db;
var G__28665 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28664;
frames = G__28665;
continue;
...
case "pattern":
var G__28666 = db;
var G__28667 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28666;
frames = G__28667;
continue;
