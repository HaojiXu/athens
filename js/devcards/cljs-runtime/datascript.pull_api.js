...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__28587){
while(true){
...
var frame = first__28590;
var frames = seq__28589__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__28630 = db;
var G__28631 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28630;
p__28587 = G__28631;
continue;
}
...
case "expand":
var G__28636 = db;
var G__28637 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28636;
frames = G__28637;
continue;
...
case "expand-rev":
var G__28638 = db;
var G__28639 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28638;
frames = G__28639;
continue;
...
case "pattern":
var G__28643 = db;
var G__28644 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28643;
frames = G__28644;
continue;
...
case "recursion":
var G__28645 = db;
var G__28646 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28645;
frames = G__28646;
continue;
...
var G__28650 = db;
var G__28651 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28599 = cljs.core.first(remaining);
