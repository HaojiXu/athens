...
var G__58937 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58938 = n;
var G__58939 = cljs.core.nnext(bs);
var G__58940 = true;
ret = G__58937;
n = G__58938;
bs = G__58939;
seen_rest_QMARK_ = G__58940;
continue;
} else {
...
});})(G__58930,gmap,defaults,pvec,bents))
;
return fexpr__58929(G__58930);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58913_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58913_SHARP_);
}
})(),cljs.core.name(p1__58913_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58914_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58914_SHARP_);
}
})(),cljs.core.name(p1__58914_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58915_SHARP_,p2__58916_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58915_SHARP_,p2__58916_SHARP_,(function (){var fexpr__58934 = cljs.core.val(entry);
return (fexpr__58934.cljs$core$IFn$_invoke$arity$1 ? fexpr__58934.cljs$core$IFn$_invoke$arity$1(p2__58916_SHARP_) : fexpr__58934.call(null,p2__58916_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58935 = cljs.core.key(entry);
return (fexpr__58935.cljs$core$IFn$_invoke$arity$1 ? fexpr__58935.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58935.call(null,bes));
})());
...
var G__58945 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58946 = cljs.core.next(bes);
ret = G__58945;
bes = G__58946;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58917_SHARP_){
return (cljs.core.first(p1__58917_SHARP_) instanceof cljs.core.Keyword);
}),bents));
