...
var temp__5733__auto___20976 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20976)){
var seen_errors_20977 = temp__5733__auto___20976;
if(cljs.core.truth_(seen_errors_20977.has(self))){
} else {
seen_errors_20977.add(self);

var temp__5735__auto___20978 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20978)){
var sense_20979 = temp__5735__auto___20978;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20979)].join(''));
} else {
}
}
} else {
