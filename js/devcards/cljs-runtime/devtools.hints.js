...
var temp__5733__auto___20917 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20917)){
var seen_errors_20918 = temp__5733__auto___20917;
if(cljs.core.truth_(seen_errors_20918.has(self))){
} else {
seen_errors_20918.add(self);

var temp__5735__auto___20920 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20920)){
var sense_20921 = temp__5735__auto___20920;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20921)].join(''));
} else {
}
}
} else {
