...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__56202 = (function (){var G__56203 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__56203) : parser.call(null,G__56203));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__56202) : tag_set.call(null,G__56202));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__56207){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56208__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56208__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__56212,hidden_QMARK_){
...
var p = map__56213__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56213__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56213__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56213__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56213__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56213__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__56216_56242 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56217_56243 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56218_56244 = true;
var _STAR_print_fn_STAR__temp_val__56219_56245 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56218_56244);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56219_56245);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56217_56243);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56216_56242);
}
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__56224){
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__56227(s__56228){
return (new cljs.core.LazySeq(null,(function (){
var s__56228__$1 = s__56228;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56228__$1);
if(temp__5735__auto__){
var s__56228__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56228__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56228__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56230 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56229 = (0);
while(true){
if((i__56229 < size__4581__auto__)){
var vec__56231 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56229);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56231,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56231,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__56230,instaparse.print.rule__GT_str(non_terminal,parser));

var G__56250 = (i__56229 + (1));
i__56229 = G__56250;
continue;
} else {
var G__56251 = (i__56229 + (1));
i__56229 = G__56251;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56230),instaparse$print$Parser__GT_str_$_iter__56227(cljs.core.chunk_rest(s__56228__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56230),null);
}
} else {
var vec__56234 = cljs.core.first(s__56228__$2);
...
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__56227(cljs.core.rest(s__56228__$2)));
} else {
var G__56252 = cljs.core.rest(s__56228__$2);
s__56228__$1 = G__56252;
continue;
}
}
} else {
