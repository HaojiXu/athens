...
var G__48481 = (i__4790__auto___48477 + (1));
i__4790__auto___48477 = G__48481;
continue;
} else {
}
break;
...
var G__48563 = cljs.spec.alpha.get_spec(x);
x = G__48563;
continue;
} else {
...
var G__48566 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48566;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48603 = cljs.spec.alpha.get_spec(x);
x = G__48603;
continue;
} else {
