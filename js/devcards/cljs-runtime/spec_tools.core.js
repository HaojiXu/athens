...
var G__48536 = cljs.spec.alpha.get_spec(x);
x = G__48536;
continue;
} else {
...
var G__48540 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48540;
continue;
} else {
