...
var G__48547 = cljs.spec.alpha.get_spec(x);
x = G__48547;
continue;
} else {
...
var G__48551 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48551;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48591 = cljs.spec.alpha.get_spec(x);
x = G__48591;
continue;
} else {
