...
var G__48587 = cljs.spec.alpha.get_spec(x);
x = G__48587;
continue;
} else {
...
var G__48591 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48591;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48609 = cljs.spec.alpha.get_spec(x);
x = G__48609;
continue;
} else {
