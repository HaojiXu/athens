...
var G__53705 = cljs.spec.alpha.get_spec(x);
x = G__53705;
continue;
} else {
...
var G__53706 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__53706;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__53715 = cljs.spec.alpha.get_spec(x);
x = G__53715;
continue;
} else {
